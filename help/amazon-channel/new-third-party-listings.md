...
- **[!UICONTROL Create New Catalog Product(s)]** : choisissez d’utiliser les informations de la liste Amazon pour créer automatiquement un produit dans votre catalogue [!DNL Commerce]. Ce processus fait automatiquement correspondre la liste Amazon au nouveau produit de catalogue. Voir [Création et attribution de produits de catalogue](./creating-assigning-catalog-products.md).

- **[!UICONTROL Attempt Automatic Match]** : choisissez d’effectuer une correspondance automatique pour les listes sélectionnées dans votre catalogue en fonction de vos options actuelles de [recherche catalogue](./catalog-search.md) dans vos paramètres de liste. Si vous modifiez vos options _[!UICONTROL Catalog Search]_, cette action vous permet de réessayer le processus correspondant.

Sous _[!UICONTROL Select]_:

- **[!UICONTROL Assign Catalog Product]** : choisissez de faire correspondre manuellement la liste à un produit de votre catalogue [!DNL Commerce]. Voir [Création et attribution de produits de catalogue](./creating-assigning-catalog-products.md).
