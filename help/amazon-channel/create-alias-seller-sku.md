...
description: Vous pouvez utiliser le SKU du vendeur Amazon d’alias pour créer des listes Amazon multirégionales à partir de vos produits de catalogue Commerce.
...
- Créez un [!DNL Alias Amazon Seller SKU] et faites correspondre l’un de vos produits de catalogue [!DNL Commerce] à deux listes Amazon.
...
Affichez la liste sur la page _[!UICONTROL Product Listings]_(_[!UICONTROL Inactive]_, _Active_, _Inéligible_ ou _Ended_ onglet).
...
1. Affichez la liste sur la page _[!UICONTROL Product Listings]_(_[!UICONTROL Inactive]_, _[!UICONTROL Active]_,_[!UICONTROL Ineligible]_ ou _[!UICONTROL Ended]_onglets).
...
![créer un SKU de vendeur Amazon d’alias](assets/amazon-alias-sku-create.png){width="600" zoomable="yes"}
