...
| Tenter la correspondance automatique | Tenter une correspondance automatique entre vos [!DNL Commerce] catalogue et vos listes Amazon en fonction des paramètres des critères de recherche. Pour tenter une correspondance, vous devez modifier votre [Liste](./listing-settings.md) et [Recherche catalogue](./catalog-search.md) pour augmenter le potentiel de correspondance automatique. | [[!UICONTROL New Third Party]](./new-third-party-listings.md) |
